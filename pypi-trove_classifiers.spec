...
Source0  : https://files.pythonhosted.org/packages/42/09/c07dd7fab889708e6322884461a5be112f858bcd44c13d355dafde9cccf1/trove-classifiers-2022.12.1.tar.gz
...
%prep
%setup -q -n trove-classifiers-2022.12.1
cd %{_builddir}/trove-classifiers-2022.12.1
pushd ..
cp -a trove-classifiers-2022.12.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669935916
