...
Source0  : https://files.pythonhosted.org/packages/78/c9/83f915c3f6f94f4c862c7470284fd714f312cce8e3cf98361312bc02493d/trove_classifiers-2024.7.2.tar.gz
...
%prep
%setup -q -n trove_classifiers-2024.7.2
cd %{_builddir}/trove_classifiers-2024.7.2
pushd ..
cp -a trove_classifiers-2024.7.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720049261
