...
%prep
%setup -q -n trove-classifiers-2022.12.22
cd %{_builddir}/trove-classifiers-2022.12.22
pushd ..
cp -a trove-classifiers-2022.12.22 buildavx2
cp -a trove-classifiers-2022.12.22 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671726732
