...
Source0  : https://files.pythonhosted.org/packages/ac/5b/82aad0f0d217d089cf3d806e67a7cac03089e2da1a9df6c45578783d31e6/trove-classifiers-2023.2.20.tar.gz
...
%prep
%setup -q -n trove-classifiers-2023.2.20
cd %{_builddir}/trove-classifiers-2023.2.20
pushd ..
cp -a trove-classifiers-2023.2.20 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676921354
