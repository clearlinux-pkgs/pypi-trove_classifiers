...
Source0  : https://files.pythonhosted.org/packages/a1/ba/ef6787959696b3946073767864c0ba8b5fb5075c2afaa76cf457085e8364/trove-classifiers-2023.1.20.tar.gz
...
%prep
%setup -q -n trove-classifiers-2023.1.20
cd %{_builddir}/trove-classifiers-2023.1.20
pushd ..
cp -a trove-classifiers-2023.1.20 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674230156
