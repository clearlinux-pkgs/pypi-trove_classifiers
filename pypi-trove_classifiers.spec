...
Source0  : https://files.pythonhosted.org/packages/13/8e/15ba2980e2704edecc53d15506a5bfa6efb3b1cadc5e4df7dc277bc199f8/trove_classifiers-2025.2.18.16.tar.gz
...
%prep
%setup -q -n trove_classifiers-2025.2.18.16
cd %{_builddir}/trove_classifiers-2025.2.18.16
pushd ..
cp -a trove_classifiers-2025.2.18.16 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739900520
