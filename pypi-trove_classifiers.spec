...
Source0  : https://files.pythonhosted.org/packages/c5/e9/1deb1b8113917aa735b08ef21821f3533bda2eb1fa1a16e07256dd05918f/trove-classifiers-2024.3.25.tar.gz
...
%prep
%setup -q -n trove-classifiers-2024.3.25
cd %{_builddir}/trove-classifiers-2024.3.25
pushd ..
cp -a trove-classifiers-2024.3.25 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711407087
