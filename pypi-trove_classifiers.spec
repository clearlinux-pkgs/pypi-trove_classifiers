...
Source0  : https://files.pythonhosted.org/packages/13/11/e13906315b498cb8f5ce5a7ff39fc35941e8291e914158157937fd1c095d/trove-classifiers-2024.3.3.tar.gz
...
%prep
%setup -q -n trove-classifiers-2024.3.3
cd %{_builddir}/trove-classifiers-2024.3.3
pushd ..
cp -a trove-classifiers-2024.3.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709569768
