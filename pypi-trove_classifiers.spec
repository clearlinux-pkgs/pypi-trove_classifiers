...
Source0  : https://files.pythonhosted.org/packages/c2/d3/2c793df6cea96eda294daa400e4b6f06cd75b7a65005eb2c84aae2d08c5c/trove-classifiers-2024.1.31.tar.gz
...
%prep
%setup -q -n trove-classifiers-2024.1.31
cd %{_builddir}/trove-classifiers-2024.1.31
pushd ..
cp -a trove-classifiers-2024.1.31 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706802467
