...
Source0  : https://files.pythonhosted.org/packages/73/e9/b732ae50ebe5e4949bb20a47243d9fee6f3c15027c3f8ffeaa0982e68173/trove-classifiers-2024.4.10.tar.gz
...
%prep
%setup -q -n trove-classifiers-2024.4.10
cd %{_builddir}/trove-classifiers-2024.4.10
pushd ..
cp -a trove-classifiers-2024.4.10 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712765172
