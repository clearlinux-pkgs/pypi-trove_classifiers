...
%prep
%setup -q -n trove-classifiers-2024.1.8
cd %{_builddir}/trove-classifiers-2024.1.8
pushd ..
cp -a trove-classifiers-2024.1.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704729438
