...
Source0  : https://files.pythonhosted.org/packages/16/14/55ceb59dabf95f554b5368fdabe8d370165a25f817a23d809ad6c87a0b06/trove_classifiers-2024.9.12.tar.gz
...
%prep
%setup -q -n trove_classifiers-2024.9.12
cd %{_builddir}/trove_classifiers-2024.9.12
pushd ..
cp -a trove_classifiers-2024.9.12 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726238171
