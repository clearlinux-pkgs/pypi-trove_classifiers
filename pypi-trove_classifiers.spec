...
Source0  : https://files.pythonhosted.org/packages/e2/9c/6338596a8f16b060c8bcaaf3fc21c9c92707fbb687cb2627c0da05b05057/trove-classifiers-2023.2.8.tar.gz
...
%prep
%setup -q -n trove-classifiers-2023.2.8
cd %{_builddir}/trove-classifiers-2023.2.8
pushd ..
cp -a trove-classifiers-2023.2.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675885785
