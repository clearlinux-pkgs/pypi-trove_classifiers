...
%prep
%setup -q -n trove-classifiers-2023.10.18
cd %{_builddir}/trove-classifiers-2023.10.18
pushd ..
cp -a trove-classifiers-2023.10.18 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697640642
