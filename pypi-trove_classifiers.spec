...
Source0  : https://files.pythonhosted.org/packages/52/db/cd8510702ed0ac1215e960ab3511a7f5750d63b56f2ae94d94fb4a6425af/trove_classifiers-2025.4.11.15.tar.gz
...
%prep
%setup -q -n trove_classifiers-2025.4.11.15
cd %{_builddir}/trove_classifiers-2025.4.11.15
pushd ..
cp -a trove_classifiers-2025.4.11.15 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744391650
